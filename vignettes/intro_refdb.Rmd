...
Developing and maintaining a reference database can be a difficult task. This vignette will present the main functions of the `refdb` package that can assist you in the quest for a powerful and error-free reference library.
