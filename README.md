...
<!-- badges: start -->
[![R-CMD-check](https://github.com/fkeck/refdb/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/fkeck/refdb/actions/workflows/R-CMD-check.yaml)
[![Codecov test coverage](https://codecov.io/gh/fkeck/refdb/graph/badge.svg)](https://app.codecov.io/gh/fkeck/refdb)
<!-- badges: end -->
